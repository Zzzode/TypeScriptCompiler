...
tar -xvzf gc-8.2.4.tar.gz -C ./3rdParty/
tar -xvzf libatomic_ops-7.8.0.tar.gz -C ./3rdParty/
cp -a ./3rdParty/libatomic_ops-7.8.0/ ./3rdParty/gc-8.2.4/libatomic_ops/
cp -ar ./docs/fix/gc/* ./3rdParty/gc-8.2.4/
